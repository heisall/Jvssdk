...
@interface JVCVideoDecoderInterface : NSObject
...
void  yuv_rgb_04(int nlchannel,unsigned int* outdata,int  systemVersion);
unsigned char* CreateBitmap_04(unsigned char *pixels,int w,int h,int  systemVersion);
...
void JVD05_DecodeOpen (int nlchannel, int codecID);
...
/**********************************************************************************/
int   JVD05_DecodeOneFrame(int nlchannel,int dataSize,unsigned char *inData , unsigned char **ppY,unsigned char **ppU,unsigned char **ppV, int bDelayFrame,int systemVersion,int deviceType,int*decodeOutWidth,int* decodeOutHeight);
